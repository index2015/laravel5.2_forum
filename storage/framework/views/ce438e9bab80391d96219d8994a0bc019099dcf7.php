...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_2").jqGrid({
            url:'<?php echo e(url('PostBar/postDataList?dataType=data')); ?>',
            datatype: "json",
            height: 450,
            autowidth: true,
            shrinkToFit: true,
            ...
            colModel: [
                ...
                {name: 'postContent', index: 'postContent', editable: true, width: 100,formatter:function(value,row,index){
                    ...
                    return '<a href="<?php echo e(url('forum/showPost?')); ?>id='+id+'&postBar='+postBar+'" target="_blank">连接+</a>';
                }},
                {name: 'postUid', index: 'postUid', editable: true, width: 80, align: "right", sorttype: "int"},
                {name: 'postBar', index: 'postBar', editable: true, width: 80, align: "right",edittype:"select", editrules:{edithidden:true},editoptions:{dataUrl: '<?php echo e(url("PostBar/Grouping?postBar=7")); ?>'}},
            ...
            edittext: '编辑会员',
            prmNames:{id:'id'},
            editurl: "<?php echo e(url('indexUpdate')); ?>",
            hidegrid: false
        });
