...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_2").jqGrid({
            url:'<?php echo e(url('PostBar/showData')); ?>',
//            datastr: topicjson,
            datatype: "json",
            height: 450,
            ...
            colModel: [
                ...
                {name: 'The' ,hidden:true,index: 'The',editable: true,edittype:"select",editrules:{edithidden:true},editoptions:{dataUrl: '<?php echo e(url("PostBar/selectData")); ?>'}},
            ...
            edittext: '编辑帖吧',
            prmNames:{PId:'PId'},
            editurl: "<?php echo e(url('PostBar/saveData')); ?>?_token=<?php echo e(csrf_token()); ?>",
            hidegrid: false
        });
