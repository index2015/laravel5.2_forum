    ...
    $(document).ready(function () {
        ...
        $("#table_list_2").jqGrid({
            ...
            colModel: [
                ...
                {name: 'updated_at', index: 'updated_at', editable: true, width: 100, sortable: false} , {name: 'group', index: 'group', editable: true, width: 100, sortable: false}
            ],
            pager: "#pager_list_2",
            viewrecords: true,
            caption: "系统管理员",
        ...
        //新增、修改、删除
        $("#table_list_2").jqGrid('navGrid', '#pager_list_2', {edit: false, add: false, del: false, search: false,view: true},
