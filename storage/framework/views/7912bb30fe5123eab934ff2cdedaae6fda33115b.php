...
<?php /*<?php echo $__env->make('index.public.login', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>*/ ?>
<?php /*<?php echo $__env->make('index.public.request', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>*/ ?>
...
<div class="content" id="index">
        ...
        <div class="box main_box">
            ...
            <div id="diy2" class="area"><div id="frametVRynP" class="frame move-span cl frame-1"><div id="frametVRynP_left" class="column frame-1-c"><div id="frametVRynP_left_temp" class="move-span temp"></div><div id="portal_block_13" class="block move-span"><div id="portal_block_13_content" class="dxb_bc">			<!-- 小图推荐 -->
                                ...
                                <div class="recommend_article_list">
                                    <ul>
                                        <?php foreach($postData as $vo): ?>
                                            <li>
                                                <a href="<?php echo e(url('forum/showPost?id='.$vo['id'].'&postBar='.$vo['postBar'])); ?>" target="_blank" title="Tesla Model S 地球上最酷的量产纯电动轿车">
                                                    <em>●</em><?php echo e($vo['postName']); ?></a>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                </div>
            ...
            <div class="graybg graytopborder index_tab" name="threadsbody" id="threadsbody">
                ...
                <div class="tab" style="width: 330px;">
                    ...
                    <ul>
                        <li  <?php if(@$_GET['order']=='postAddTime' || @$_GET['order']==''): ?> class="a"  <?php endif; ?> ><a href="<?php echo e(url('/?order=postAddTime')); ?>">时间<span></span></a></li>
                        <li  <?php if(@$_GET['order']=='numberOfReviews'): ?> class="a"  <?php endif; ?>><a href="<?php echo e(url('/?order=numberOfReviews')); ?>">回复<span></span></a></li>
                        <li  <?php if(@$_GET['order']=='postAccessTimes'): ?> class="a"  <?php endif; ?>><a href="<?php echo e(url('/?order=postAccessTimes')); ?>">查看<span></span></a></li>
                        <li  <?php if(@$_GET['order']=='postEssence'): ?> class="a"  <?php endif; ?>><a href="<?php echo e(url('/?order=postEssence')); ?>">精华<span></span></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="thread minh" style="position: relative;">
                ...
                <?php foreach($barPostDataHome as $vo): ?>
                    <div class="threadlist">
                        <div class="threadlist_stat threadlist_stat_hot">
                            <a href="<?php echo e(url('forum/showPost?postBar='.$vo['postBar'].'&id='.$vo['id'])); ?>" title="<?php echo e($vo['postAccessTimes']); ?>个查看"><?php echo e($vo['postAccessTimes']); ?></a>
                        </div>
                        <div class="threadlist_title">
                            <div class="right">
                            </div>
                            <a href="<?php echo e(url('forum/showPost?postBar='.$vo['postBar'].'&id='.$vo['id'])); ?>" ><?php echo e($vo['postName']); ?></a>
                        ...
                        <div class="threadlist_info">
                            <div class="lastreply">
                                <a href="#"> <span title=""><?php echo e(date('Y-m-d H:i:s',$vo['postAddTime'])); ?></span></a>
                            </div>
                            <a href="#"><?php echo e($vo['creator_name']); ?></a> @ <?php echo e(date('Y-m-d H:i:s',$vo['bar_addtime'])); ?><span class="pipe">|</span>
                        <span class="greencolor">
                            <a href="<?php echo e(url('forum/postForum?id='.$vo['postBar'].'')); ?>"><strong><?php echo e($vo['bar_name']); ?></strong></a>
                        </span>
                        </div>
                    </div>
                <?php endforeach; ?>
            ...
            <?php /*<div class="nextpage">*/ ?>
            <?php /*<a href="javasctipt:;">下一页</a>*/ ?>
            <?php /*</div>*/ ?>
        </div>
        <div class="pg">
            <?php echo $barPostDataHome->links(); ?>
    ...
    <div class="sidebar">
            ...
            <div class="featured _flslide">
                ...
                <div id="frameraciFi_left" class="column frame-1-c"><div id="frameraciFi_left_temp" class="move-span temp"></div>
                    <div id="portal_block_14" class="block move-span"><div id="portal_block_14_content" class="dxb_bc">
                            <div class="box">
                                <h3 class="modname"><span class="more"><?php echo e(CMS); ?></span>全民话题</h3>
                    ...
                    <div id="portal_block_15" class="block move-span"><div id="portal_block_15_content" class="dxb_bc">		<div class="box s_forumlist">
                                ...
                                <div class="s_links">
                                    <ul class="s_grid_line">
                                        <?php foreach($postBar as $vo): ?>
                                            <li>
                                                <a href="<?php echo e(url('forum/postForum?id='.$vo['PId'])); ?>"><i>
                                                        <img src="<?php echo e($vo['thumbnail']); ?>" width="24" height="24">
                                                    </i><small class="a_arrow"></small><em><?php echo e($vo['describe']); ?></em><span><?php echo e($vo['bar_name']); ?></span>
                                                </a>
                                            </li>
                                        <?php endforeach; ?>
                                ...
                                <div class="grid_stat">
                                    <div class="grid_list">
                                        <ul>
                                            <?php foreach($Bar  as $vo): ?>
                                                <li>
                                                    <a href="<?php echo e(url('forum/postForum?id='.$vo['PId'])); ?>" style="width:75px;">
                                                    <span class="grid_list_img">
                                                <img src="<?php echo e($vo['thumbnail']); ?>" width="30" height="30"></span><?php echo e($vo['bar_name']); ?></a>
                                                </li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                ...
                                <div class="s_links">
                                    <ul>
                                        <?php foreach($userList as $k=>$vo): ?>
                                            <li>
                                                <a href="#" target="_blank"><span class="s_top_num redcolor"> <?php if($k+11=='3'): ?> <span class="s_top_num bluecolor">...</span> <?php else: ?> <?php echo e($k+1); ?>  <?php endif; ?> </span>
                                                    <i>
                                                        <img src="<?php echo e($vo['head_portrait']); ?>" onerror="this.onerror=null;this.src='/data/upload/images/10_avatar_middle.jpg'">
                                                    </i>
                                                    <em>0</em>
                                                    <span><?php echo e($vo['name']); ?></span>
                                                </a>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
        ...
        <div class="box">
            <h3 class="modname"><span class="more"><a href="javascript:void(0)"><?php echo e(CMS); ?>固件列表<em>&gt;&gt;</em></a></span> <?php echo e(CMS); ?> 更新</h3>
