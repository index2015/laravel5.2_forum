...
<link rel="stylesheet" href="<?php echo e(asset('/static/css/post.css')); ?>">
    ...
    <div id="editorbox">
        ...
        <div id="postbox" class="p20">
            <form method="post" autocomplete="off" id="postform" action="" >
                ...
                <input type="hidden" name="postBa" id="postBa" value="<?php echo e($postBar); ?>">
...
<script>
    function postsubmitForm(){
        ...
        $.ajax({
            type:"POST",
            dataType:'json',
            url:'<?php echo e(url('forum/memberPost')); ?>',
            data:ValData,
            success:function(msg){
                if(msg.state==1){
                    success(msg.msg,'<?php echo e(url('forum/postForum')); ?>?_token=<?php echo e(csrf_token()); ?>&id=<?php echo  $_GET['id']?>');
                }else{
                    this_error("操作失败");
                }
            }
