...
<div class="wrapper wrapper-content  animated fadeInRight">
    ...
    <div class="alert alert-success alert-dismissable">
        ...
        <?php echo e(CMS); ?>:权限配置系统已根据权限菜单展现方式,请务必配置路径信息.
    </div>
    <div class="row">
        <div class="col-sm-12">
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_2").jqGrid({
            url:'<?php echo e(url('system/showJurisdictionData')); ?>',
            datatype: "json",
            height: 450,
            autowidth: true,
            shrinkToFit: true,
            ...
            edit: true,
            prmNames:{id:'id'},
            editurl: "<?php echo e(url('system/saveJurisdictionData')); ?>?_token=<?php echo e(csrf_token()); ?>",
            hidegrid: false,
            subGridRowExpanded:function(subgrid_id,row_id){
                ...
                jQuery("#"+subgrid_table_id).jqGrid({
                    url:'<?php echo e(url('index/adminData')); ?>',
                    title:false,
                    datatype: "json",
                    ...
                    colModel: [
                        ...
                        {name: 'RouteName', index: 'RouteName', editable: true, width: 80, align: "right",edittype:"select",editoptions:{dataUrl: '<?php echo e(url('')); ?>'}},
