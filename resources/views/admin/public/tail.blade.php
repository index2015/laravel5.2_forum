...
<!-- Peity -->
<script src="{{asset('/hAdmin/js/plugins/peity/jquery.peity.min.js')}}"></script>
<!-- jqGrid -->
<script src="{{asset('/hAdmin/js/plugins/jqgrid/i18n/grid.locale-cn.js?0820')}}"></script>
<script src="{{asset('/hAdmin/js/plugins/jqgrid/jquery.jqGrid.min.js?0820')}}"></script>
...
<script src="{{asset('/hAdmin/js/content.js?v=1.0.0')}}"></script>
